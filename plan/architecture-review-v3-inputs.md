...
| String-valued values paths | `AbstractValue::ValuesPath` remains string-backed and appears in 77 production source locations. The count is `rg -n 'ValuesPath' crates/*/src --glob '*.rs' --glob '!**/src/tests/**' | wc -l`, excluding crate-level `tests/` by construction and `src/tests/**` explicitly. V3 deliberately records the newtype as a later campaign rather than Steps 1–13 (`plan/architecture-review-v3.md:94`). |
