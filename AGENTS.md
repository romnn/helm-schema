...
- For YAML structure, prefer the fused parser (`helm_schema_yaml_template::fused`) over line-oriented heuristics whenever the consumer needs to understand nesting, sequences, or multi-document boundaries.
