  ...
  analyzers:
    - clusterVersion:
        outcomes:
          - fail:
              when: "< 1.33.0"
              message: Okteto requires at least Kubernetes 1.33.0
              uri: https://www.okteto.com/docs/release-notes/
          - fail:
              when: ">= 1.36.0"
              message: Okteto requires a Kubernetes version between 1.33 and 1.35
              uri: https://www.okteto.com/docs/release-notes/
          - pass:
  ...
  collectors:
    ...
    - logs:
        ...
        selector:
          ...
          - app.kubernetes.io/part-of=okteto
    - logs:
        name: buildkit-adapter-logs
        selector:
          - app.kubernetes.io/component=buildkit-adapter
          - app.kubernetes.io/part-of=okteto
    - logs:
        name: frontend-logs
        selector:
    ...
    */}}
    ...
    - logs:
        ...
        selector:
          ...
          - app.kubernetes.io/part-of=okteto
    - logs:
        name: installer-checker-logs
        selector:
          - app.kubernetes.io/component=installer-checker
          - app.kubernetes.io/part-of=okteto
    - logs:
        name: divert-controller-logs
        selector:
          - app.kubernetes.io/component=divert-controller
          - app.kubernetes.io/part-of=okteto
    - logs:
        name: redis-logs
        selector:
