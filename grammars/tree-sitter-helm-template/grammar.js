...
module.exports = grammar({
  ...
  externals: $ => [
    ...
    $._r_hlm_tpl, $._br_hlm_tpl, $._b_hlm_tpl,
    $._r_hlm_dir, $._br_hlm_dir, $._b_hlm_dir,
  ...
  extras: $ => [$.comment, $._r_hlm_dir, $._br_hlm_dir, $._b_hlm_dir],
  ...
  rules: {
    ...
    _b_blk_seq_itm: $ => choice(seq($._b_blk_seq_bgn, optional($._blk_seq_itm_tal)), $._b_hlm_tpl),
    ...
    _r_blk_map_br_val: $ => seq(choice($._r_prp, $._r_hlm_tpl), $._br_blk_map),
    ...
    _b_blk_map_itm: $ => choice($._b_blk_exp_itm, $._b_blk_imp_itm, $._b_hlm_tpl),
    ...
    _r_blk_key_itm: $ => prec.left(seq($._r_blk_key_bgn, optional(field('key', choice($._blk_seq_itm_tal, $._r_blk_seq_spc_val, $._br_blk_seq_spc_val))))),
    _br_blk_key_itm: $ => prec.left(seq($._br_blk_key_bgn, optional(field('key', choice($._blk_seq_itm_tal, $._r_blk_seq_spc_val, $._br_blk_seq_spc_val))))),
    _b_blk_key_itm: $ => prec.left(seq($._b_blk_key_bgn, optional(field('key', choice($._blk_seq_itm_tal, $._r_blk_seq_spc_val, $._br_blk_seq_spc_val))))),

    _r_blk_val_itm: $ => prec.left(seq($._r_blk_val_bgn, optional(field('value', choice($._blk_seq_itm_tal, $._r_blk_seq_spc_val, $._br_blk_seq_spc_val))))),
    _br_blk_val_itm: $ => prec.left(seq($._br_blk_val_bgn, optional(field('value', choice($._blk_seq_itm_tal, $._r_blk_seq_spc_val, $._br_blk_seq_spc_val))))),
    _b_blk_val_itm: $ => prec.right(seq($._b_blk_val_bgn, optional(field('value', $._blk_exp_itm_tal)))),
    ...
    _blk_imp_itm_tal: $ => seq(
      ...
      optional(field('value', choice(
        prec(1, seq($._r_hlm_tpl, $._br_blk_seq)),
        prec(1, seq($._r_hlm_tpl, $._br_blk_map)),
        $._r_blk_seq_br_val,
        $._br_blk_seq_val,
        $._r_blk_seq_spc_val,
        $._br_blk_seq_spc_val,
    ...
    _r_flw_njl_val_blk: $ => choice($._r_als_val, $._r_prp_val, $._r_pln_blk_val, $._r_hlm_tpl),
    _br_flw_njl_val_blk: $ => choice($._br_als_val, $._br_prp_val, $._br_pln_blk_val, $._br_hlm_tpl),

    _r_sgl_flw_njl_val_blk: $ => choice($._r_als_val, $._r_sgl_prp_val, $._r_sgl_pln_blk_val, $._r_hlm_tpl),
    _br_sgl_flw_njl_val_blk: $ => choice($._br_als_val, $._br_sgl_prp_val, $._br_sgl_pln_blk_val, $._br_hlm_tpl),
    _b_sgl_flw_njl_val_blk: $ => choice($._b_als_val, $._b_sgl_prp_val, $._b_sgl_pln_blk_val, $._b_hlm_tpl),

    // non-json-like flow value in flow

    _r_flw_njl_val_flw: $ => choice($._r_als_val, $._r_prp_val, $._r_pln_flw_val, $._r_hlm_tpl),
    _br_flw_njl_val_flw: $ => choice($._br_als_val, $._br_prp_val, $._br_pln_flw_val, $._br_hlm_tpl),

    _r_sgl_flw_njl_val_flw: $ => choice($._r_als_val, $._r_sgl_prp_val, $._r_sgl_pln_flw_val, $._r_hlm_tpl),
...
module.exports.grammar = global_alias(global_alias(module.exports.grammar, {
  ...
  ..._('helm_template', '_r_hlm_tpl', '_br_hlm_tpl', '_b_hlm_tpl'),
